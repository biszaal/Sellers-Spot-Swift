...
struct NewPostView: View
{
    ...
    @State var postCategories: [String] =
        ["Arts & Crafts",
         "Electronics",
         "Books",
         "Computers",
    ...
    @State var postCategory: String = "Clothes"
                    ...
                    VStack(alignment: .leading, spacing: 20)
                    {
                        ...
                        Group
                        {
                            ...
                            Menu
                            {
                                ...
                                ForEach(self.postCategories, id: \.self)
                                { each in
                                    
                                    Button(action: {
                                        self.postCategory = each
                                    })
                                    {
                                        Text(each)
                                    }
                                ...
                                Label(
                                    ...
                                    icon: {
                                        HStack
                                        {
                                            ...
                                            Image(systemName: "arrowtriangle.down").padding()
                                        }
                        ...
                        Group
                        {
                            HStack
                            {
                                ...
                                Text("\(storeImages.count) / 5 images")
    ...
    func addPost()
    {
        ...
        self.post.addPost(id: postId, userId: userId, username: userEmail, userImage: userImage, postName: postName, postLocation: postLocation, postImage: postImages, postDescription: postDescription, postCategory: postCategory, postPrice: postPrice)
